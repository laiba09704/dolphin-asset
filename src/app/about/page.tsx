      ...
      <section className="w-full bg-white py-20">
        <div className="w-full px-6 xl:px-10">
          <div className="xl:ml-24 xl:mr-24 h-auto lg:h-[320px] bg-white border-[0.5px] border-[#d1d5db] rounded-[13px] flex flex-col lg:flex-row items-center overflow-hidden shadow-sm">
            ...
            <div
              className="w-full lg:w-1/2 h-full p-8 md:p-10 relative flex flex-col justify-between"
          ...
          <div className="xl:ml-24 xl:mr-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {[
                ...
                <div
                  key={idx}
                  className="bg-white py-6 px-4 md:px-5 flex flex-col justify-start w-full h-full min-h-[160px]"
                  style={{
                    borderRadius: "9.57px",
                    borderWidth: "0.96px",
                    borderStyle: "solid",
      ...
      <section className="w-full py-20 bg-[#F4F7FB]">
        <div className="w-full px-6 xl:px-10">
          <div className="xl:ml-24 xl:mr-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border-none shadow-none">
              {/* Card 01 - Dark Blue */}
              <div className="bg-[#01286D] text-white p-8 sm:p-10 relative flex flex-col justify-between min-h-[260px]">
              ...
              <div className="bg-transparent p-8 sm:p-10 relative flex flex-col justify-between min-h-[260px] border-none shadow-none outline-none">
      ...
      <section className="w-full bg-white pb-20">
        <div className="w-full px-6 xl:px-10">
          <div className="xl:ml-24 xl:mr-24">
            ...
            <h2
              className={`${sourceSerif.className} text-[#01286D] font-bold text-3xl sm:text-4xl mb-4`}
            >
